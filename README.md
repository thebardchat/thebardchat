...
```
┌─────────────────────────────────────────────────────────┐
│  SHANEBRAIN ECOSYSTEM  ·  thebardchat  ·  Hazel Green AL │
└─────────────────────────────────────────────────────────┘
```
...
Dispatcher. Father. Coach. Builder. Author. Sober since November 27, 2023.
...
**A collection of noir-style vignettes about ego, identity, and the universal human condition.**

Written in third person. Dark but light. Cynical but comical.

*It was always about you. It was never only about you.*

**[Buy on Amazon](https://www.amazon.com/Probably-Think-This-Book-About/dp/B0GT25R5FD)**

Written by Shane Brazelton. Co-built with Claude (Anthropic). Built on a Raspberry Pi 5.

**[See the writing process](https://github.com/thebardchat/noir-detective-writing-process)** — how raw voice dumps recorded while driving become noir prose.
...
| Hardware | Role |
|----------|------|
| Raspberry Pi 5 (16GB) | Local AI inference node |
| Pironman 5-MAX by Sunfounder | NVMe RAID 1 chassis |
| 2x WD Blue SN5000 2TB NVMe | RAID 1 via mdadm |

```
Ollama · Weaviate · FastMCP · Tailscale · Claude Code · Docker
```
...
ShaneBrain          →  Local AI on Pi 5. Private. Yours.
  └── Angel Cloud   →  Public platform. Families. Mental wellness.
        └── Pulsar AI         →  Enterprise. Post-quantum crypto.
...
| Repo | What It Is |
|------|-----------|
| [shanebrain-core](https://github.com/thebardchat/shanebrain-core) | Personal AI system — Discord bot, RAG, Weaviate, social automation |
...
| [srm-dispatch](https://github.com/thebardchat/srm-dispatch) | SRM Concrete daily dispatch PWA for 18 drivers |
...
## Everything I Build Follows the Constitution
...
<table>
  <tr>
    ...
    <td align="center" width="200">
      ...
      <a href="https://www.pironman.com"><code>pironman.com</code></a>
    </td>
  </tr>
</table>
