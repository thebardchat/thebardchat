...
### Concrete dispatch operator. Father of five. Sober 955 days. Building local AI for the people Big Tech left behind.
...
| [BGKPJR-Stage1-Tube](https://github.com/thebardchat/BGKPJR-Stage1-Tube) | Stage 1 deep dive — 28.7 km coilgun architecture, live Three.js animation | [Repo ↗](https://github.com/thebardchat/BGKPJR-Stage1-Tube) |
...
🧠 ShaneBrain (Pi 5, primary node)
   ...
   └── 7 specialist agents — Guardian, Librarian, Dispatcher, Builder, Storyteller, Ops + 1 more
...
| Edge Hardware | Raspberry Pi Pico 2 (RP2350) | Peripheral nervous system — sensors, GPIO |
...
| 📺 **Twitch Channel** | Family streaming, AI demos, love & light — bot, overlays, go-live automation | [twitch.tv/thebardchat](https://twitch.tv/thebardchat) · [Repo ↗](https://github.com/thebardchat/twitch) |
| 🤖 **MEGA Crew** | 17 autonomous bots, 24/7, all local | [thebardchat.github.io/mega-crew](https://thebardchat.github.io/mega-crew/) · [Repo ↗](https://github.com/thebardchat/mega-crew) |
| 🧠 **shanebrain-core** | The heart of the ecosystem — Discord bot, RAG, MCP server, social automation, on one Pi 5 | [github.com/thebardchat/shanebrain-core](https://github.com/thebardchat/shanebrain-core) |
...
| 🤝 **shanebrain-agents** | 7 specialist AI agents — Guardian, Librarian, Dispatcher, Builder, Storyteller, Ops + 1 more | [github.com/thebardchat/shanebrain-agents](https://github.com/thebardchat/shanebrain-agents) |
...
| 🚚 **pedal-to-the-metal** | Concrete dispatch SaaS — built by a dispatcher, for dispatchers | [github.com/thebardchat/pedal-to-the-metal](https://github.com/thebardchat/pedal-to-the-metal) |
| 💰 **HaloFinance** | AI budgeting, forecasting & debt strategy for working families | [github.com/thebardchat/HaloFinance](https://github.com/thebardchat/HaloFinance) |
| 🏥 **Greenfield** | Claim Cruncher — AI medical billing intake, EOB parsing, dispute routing | [github.com/thebardchat/Greenfield](https://github.com/thebardchat/Greenfield) |
| 📜 **Quantum Legacy AI Stick** | USPTO provisional patent — portable edge AI co-processor w/ Pulsar Sentinel audit trail | [github.com/thebardchat/quantum-legacy-ai-stick](https://github.com/thebardchat/quantum-legacy-ai-stick) |
...
**[Buy on Amazon](https://www.amazon.com/Probably-Think-This-Book-About/dp/B0GT25R5FD)** · **[Repo](https://github.com/thebardchat/you-probably-think-this-book-is-about-you)** · **[The Song ↗](https://github.com/thebardchat/you-probably-think-this-song-is-about-you-too)**
...
Most dev profiles stop at the repo list. This ecosystem doesn't.

<div align="center">

| Platform | Project | Link |
|----------|---------|------|
| 🕶️ **Horizon Worlds** (Meta) | The Bard Chat creator profile — promo kit, animated banner | [Repo ↗](https://github.com/thebardchat/horizon-meta-profile) |
| 🎮 **Roblox** | Angel Cloud wellness game — Luau scripts, Rojo sync | [Repo ↗](https://github.com/thebardchat/angel-cloud-roblox) |
| 📺 **Twitch** | Live AI demos, family streaming, love & light | [twitch.tv/thebardchat](https://twitch.tv/thebardchat) |
| 🤗 **Hugging Face** | Models, datasets, and spaces | [huggingface.co/thebardchat](https://huggingface.co/thebardchat) |
| 📖 **Amazon** | Published fiction, built on a Pi in a closet | [Buy the book ↗](https://www.amazon.com/Probably-Think-This-Book-About/dp/B0GT25R5FD) |
